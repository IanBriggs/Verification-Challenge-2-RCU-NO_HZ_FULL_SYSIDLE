...
$bb0:
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 68, 3} true;
  $M.32[$p0] := 1;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 69, 3} true;
  $p2 := $M.2;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 69, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 70, 8} true;
  $p4 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 70, 8} true;
...
$bb2:
  assume ($p6 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 71, 5} true;
  $p7 := $sext.i32.i64($p4);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 71, 5} true;
  $p8 := $add.ref(rdp_in, $mul.ref($p7, $zext.i32.ref(312)));
  call {:cexpr "rdp"} boogie_si_record_ref($p8);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 72, 5} true;
  call rcu_sysidle_check_cpu($p8, $p0, $p1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 70, 29} true;
  $p9 := $add.i32($p4, 1);
...
$bb3:
  assume !(($p6 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 74, 3} true;
  $p10 := $M.6;
  call {:cexpr "old_full_sysidle_state"} boogie_si_record_i32($p10);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 75, 3} true;
  $p11 := $M.32[$p0];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 75, 3} true;
  $p12 := $trunc.i8.i1($p11);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 75, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 76, 3} true;
  $p15 := $M.6;
  call {:cexpr "new_full_sysidle_state"} boogie_si_record_i32($p15);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 77, 7} true;
  $p16 := $ne.i32($p10, $p15);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 77, 7} true;
  goto $bb4, $bb5;
$bb4:
  assume ($p16 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 78, 5} true;
  $p17 := $M.2;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 78, 5} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 81, 3} true;
  $p19 := $M.6;
  call {:cexpr "old_full_sysidle_state"} boogie_si_record_i32($p19);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 82, 7} true;
...
$bb7:
  assume ($p22 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 84, 5} true;
  $p23 := $M.2;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 84, 5} true;
  call $p24 := printf.ref.i64($add.ref($add.ref(.str27, $zext.i32.ref($mul.i32(0, 24))), $zext.i32.ref($mul.i32(0, 1))), $p23);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 85, 3} true;
  goto $bb9;
$bb8:
  assume !(($p22 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 86, 5} true;
  $p25 := $M.6;
  call {:cexpr "new_full_sysidle_state"} boogie_si_record_i32($p25);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 87, 9} true;
  $p26 := $ne.i32($p25, 4);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 87, 9} true;
  goto $bb10, $bb11;
$bb9:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 93, 1} true;
  $exn := false;
  return;
$bb10:
  assume ($p26 == 1);
...
$bb12:
  assume ($p27 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 89, 7} true;
  $p28 := $M.2;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 89, 7} true;
...
$bb0:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 148, 5} true;
  $p1 := $M.11;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 148, 5} true;
  $p2 := $sext.i32.i64($p1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 148, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 149, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 152, 5} true;
  $p11 := $M.11;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 152, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 153, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 155, 24} true;
  $p21 := $M.11;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 155, 24} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 156, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 157, 14} true;
  $p31 := $M.11;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 157, 14} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 158, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 159, 10} true;
  $p41 := $M.11;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 159, 10} true;
  ...
  call {:cexpr "i"} boogie_si_record_i32(0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 160, 8} true;
  $p46 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 160, 8} true;
...
$bb2:
  assume ($p48 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 161, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 161, 5} true;
  $M.0[$p55] := $p51;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 162, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 163, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 163, 5} true;
  $M.0[$p63] := $p46;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 164, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 164, 5} true;
  $M.36[$p70] := $p66;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 165, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 166, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 166, 5} true;
  $M.36[$p78] := $p46;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 167, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 168, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 169, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 171, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 171, 5} true;
  $M.0[$p93] := $p46;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 160, 29} true;
  $p94 := $add.i32($p46, 1);
...
$bb3:
  assume !(($p48 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 173, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 174, 3} true;
  ...
  call {:cexpr "i"} boogie_si_record_i32(0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 178, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 178, 66} true;
  $p101 := $add.i32(0, 1);
  call {:cexpr "i"} boogie_si_record_i32($p101);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 179, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 179, 60} true;
  $p106 := $add.i32($p101, 1);
  call {:cexpr "i"} boogie_si_record_i32($p106);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 180, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 180, 60} true;
  $p111 := $add.i32($p106, 1);
  call {:cexpr "i"} boogie_si_record_i32($p111);
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 184, 3} true;
  $p112 := $add.ref($p45, $mul.ref(0, $zext.i32.ref(4)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 184, 3} true;
  $p113 := $M.0[$p112];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 184, 3} true;
  call $p114 := pthread_join($p113, $p0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 185, 3} true;
  $p115 := $add.ref($p45, $mul.ref(1, $zext.i32.ref(4)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 185, 3} true;
  $p116 := $M.0[$p115];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 185, 3} true;
  call $p117 := pthread_join($p116, $p0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 186, 3} true;
  $p118 := $add.ref($p45, $mul.ref(2, $zext.i32.ref(4)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 186, 3} true;
  $p119 := $M.0[$p118];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 186, 3} true;
  call $p120 := pthread_join($p119, $p0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 190, 3} true;
  $p121 := $M.6;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 190, 3} true;
  $p122 := $ne.i32($p121, 4);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 190, 3} true;
...
$bb10:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 190, 3} true;
  assert $p160 != 0;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 193, 1} true;
  $r := 0;
  $exn := false;
  return;
$bb11:
...
$bb0:
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 117, 3} true;
  $p0 := arg;
  call {:cexpr "tap"} boogie_si_record_ref($p0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 119, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 120, 3} true;
  ...
  call {:cexpr "i"} boogie_si_record_i32(0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 121, 8} true;
  $p8 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 121, 8} true;
...
$bb2:
  assume ($p9 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 123, 5} true;
  $p10 := $M.6;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 123, 5} true;
  $p11 := $sgt.i32($p10, 2);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 123, 5} true;
...
$bb3:
  assume !(($p9 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 137, 3} true;
  $p25 := $M.3;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 137, 3} true;
  $p26 := $add.i32($p25, 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 137, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 138, 1} true;
  $r := $u27;
  $exn := false;
  return;
$bb4:
...
$bb5:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 123, 5} true;
  $p16 := $zext.i1.i32($p15);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 124, 5} true;
  $p17 := $M.6;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 124, 5} true;
  $p18 := $sgt.i32($p17, 2);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 124, 5} true;
...
$bb7:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 124, 5} true;
  $p23 := $zext.i1.i32($p22);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 127, 5} true;
  call rcu_sysidle_enter($p7, 0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 130, 5} true;
  call rcu_sysidle_exit($p7, 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 131, 5} true;
  call rcu_sysidle_enter($p7, 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 134, 5} true;
  call rcu_sysidle_exit($p7, 0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 121, 25} true;
  $p24 := $add.i32($p8, 1);
...
$bb0:
  call {:cexpr "rsp"} boogie_si_record_ref(rsp);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 47, 3} true;
  $r := 0;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 42, 3} true;
  call $p0 := printf.ref.i32($add.ref($add.ref(.str28, $zext.i32.ref($mul.i32(0, 45))), $zext.i32.ref($mul.i32(0, 1))), cpu);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 43, 1} true;
  $exn := false;
  return;
}
...
$bb0:
  call $p0 := $alloca($mul.ref(1, 1));
  call $p1 := $alloca($mul.ref(8, 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 320, 2} true;
  $p2 := $M.6;
  call {:cexpr "rss"} boogie_si_record_i32($p2);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 322, 6} true;
  $p3 := $M.9;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 322, 6} true;
  $p4 := $M.7;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 322, 6} true;
...
$bb3:
  assume ($p12 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 323, 3} true;
  $p13 := 0;
  goto $bb5;
$bb4:
  assume !(($p12 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 326, 6} true;
  $p14 := $M.4;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 326, 6} true;
  $p15 := $sle.i32($p14, 4);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 326, 6} true;
  ...
  goto $bb6, $bb7;
$bb5:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 378, 1} true;
  $r := $p13;
  $exn := false;
  return;
$bb6:
  assume ($p15 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 327, 3} true;
  $p17 := $sub.i32($p2, 1);
  call {:cexpr "oldrss"} boogie_si_record_i32($p17);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 333, 3} true;
  $p18, $p19 := $p17, $p2;
  goto $bb9;
$bb7:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 326, 6} true;
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 354, 6} true;
  $p41 := $eq.i32($p16, 3);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 354, 6} true;
  goto $bb20, $bb21;
$bb9:
...
$bb12:
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 335, 4} true;
  $M.32[$p0] := 1;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 336, 4} true;
  $p22 := $M.2;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 336, 4} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 340, 4} true;
  $p24 := 0;
  goto $bb14;
$bb13:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 333, 3} true;
...
$bb15:
  assume ($p26 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 341, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 342, 5} true;
  call rcu_sysidle_check_cpu($p31, $p0, $p1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 343, 9} true;
  $p32 := $M.32[$p0];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 343, 9} true;
  $p33 := $trunc.i8.i1($p32);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 343, 9} true;
...
$bb16:
  ...
  goto $bb17;
$bb17:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 346, 4} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 349, 4} true;
  $p40 := $M.6;
  call {:cexpr "rss"} boogie_si_record_i32($p40);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 350, 3} true;
  $p18, $p19 := $p19, $p40;
  goto $bb9;
$bb18:
  assume ($p33 == 1);
...
$bb20:
  assume ($p41 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 355, 9} true;
  call corral_atomic_begin();
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 355, 9} true;
  $p42 := $M.6;
...
$bb21:
  assume !(($p41 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 360, 2} true;
  ...
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 363, 6} true;
  $p45 := $eq.i32($p16, 4);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 363, 6} true;
  goto $bb25, $bb26;
$bb22:
...
$bb24:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 357, 3} true;
  $p44 := $eq.i32($p42, 3);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 357, 3} true;
  $p13 := $p44;
  goto $bb5;
$bb25:
  assume ($p45 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 364, 3} true;
  $p13 := 1;
  goto $bb5;
$bb26:
  assume !(($p45 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 373, 6} true;
  $p46 := $M.4;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 373, 6} true;
  $p47 := $sgt.i32($p46, 4);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 373, 6} true;
...
$bb27:
  assume ($p47 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 374, 7} true;
...
$bb28:
  ...
  goto $bb29;
$bb29:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 377, 2} true;
  $p13 := 0;
  goto $bb5;
$bb30:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 374, 7} true;
...
$bb31:
  assume !(($p53 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 375, 20} true;
  call corral_atomic_begin();
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 375, 20} true;
...
$bb32:
  assume ($p55 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 376, 3} true;
...
$bb0:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 221, 2} true;
  $p0 := $M.6;
  $p1 := $slt.i32($p0, 1);
  goto $bb1, $bb2;
$bb1:
...
$bb3:
  assume ($p2 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 234, 7} true;
  $p5 := $M.2;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 234, 7} true;
...
$bb5:
  assume ($p3 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 245, 7} true;
  $p12 := $M.2;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 245, 7} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 253, 1} true;
  $exn := false;
  return;
$bb8:
  assume ($p4 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 225, 3} true;
  $M.6 := 1;
  call {:cexpr "full_sysidle_state"} boogie_si_record_i32(1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 226, 3} true;
  goto $bb7;
$bb9:
  assume !(($p4 == 1));
  goto $bb7;
$bb10:
  assume ($p9 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 235, 10} true;
  call corral_atomic_begin();
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 235, 10} true;
  $p10 := $M.6;
...
$bb15:
  assume ($p16 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 246, 10} true;
  call corral_atomic_begin();
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 246, 10} true;
  $p17 := $M.6;
...
{
$bb0:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 261, 2} true;
  ...
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 262, 2} true;
  $M.6 := 0;
  call {:cexpr "full_sysidle_state"} boogie_si_record_i32(0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 263, 1} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 307, 2} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 309, 9} true;
  $p0 := rhp;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 309, 9} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 310, 2} true;
  $p3 := $add.ref($add.ref($p2, $zext.i32.ref($mul.i32(0, 24))), $zext.i32.ref($mul.i32(16, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 310, 2} true;
  $M.0[$p3] := 0;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 311, 1} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 148, 2} true;
  $p0 := $add.ref($add.ref(rdp, $zext.i32.ref($mul.i32(0, 312))), $zext.i32.ref($mul.i32(184, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 148, 2} true;
  $p1 := $M.0[$p0];
  call {:cexpr "rdtp"} boogie_si_record_ref($p1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 155, 6} true;
  $p2 := $M.32[isidle];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 155, 6} true;
  $p3 := $trunc.i8.i1($p2);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 155, 6} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 174, 1} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 155, 6} true;
...
$bb7:
  assume !(($p11 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 158, 6} true;
...
$bb8:
  assume ($p15 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 159, 3} true;
  $p16 := $M.9;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 159, 3} true;
  $p17 := $M.7;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 159, 3} true;
...
$bb9:
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 162, 8} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 163, 6} true;
  $p27 := $and.i32($p26, 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 163, 6} true;
  $p28 := $ne.i32($p27, 0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 163, 6} true;
...
$bb13:
  assume ($p28 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 164, 3} true;
  $M.32[isidle] := 0;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 165, 3} true;
  goto $bb3;
$bb14:
  assume !(($p28 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 167, 2} true;
  ...
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 170, 2} true;
  $p29 := $add.ref($add.ref($p1, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(32, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 170, 2} true;
  $p30 := $M.0[$p29];
  call {:cexpr "j"} boogie_si_record_i64($p30);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 172, 6} true;
  $p31 := $M.33[maxj];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 172, 6} true;
  $p32 := $sub.i64($p31, $p30);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 172, 6} true;
...
$bb15:
  assume ($p33 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 173, 3} true;
  $M.33[maxj] := $p30;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 173, 3} true;
  goto $bb3;
$bb16:
  ...
  modifies $pthreadStatus, $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2, $M.3, $M.4, $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.18, $M.19, $M.20, $M.21, $M.22, $M.23, $M.24, $M.25, $M.26, $M.27, $M.28, $M.29, $M.30, $M.31, $M.32, $M.33, $M.34, $M.35, $M.36, $M.37;
{
  ...
  var $p9: i32;
$bb0:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 209, 6} true;
  $p0 := $M.4;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 209, 6} true;
  $p1 := $sle.i32($p0, 4);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 209, 6} true;
...
$bb1:
  assume ($p1 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 210, 3} true;
  $p2 := 0;
  goto $bb3;
$bb2:
  assume !(($p1 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 211, 2} true;
  $p3 := $M.4;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 211, 2} true;
  $p4 := $mul.i32($p3, 1000);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 211, 2} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 212, 1} true;
  $r := $p2;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 31, 6} true;
  $p0 := $ne.i32(irq, 0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 32, 3} true;
...
$bb1:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 32, 3} true;
  $M.34[$p1] := $p3;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 33, 3} true;
...
$bb2:
  assume !(($p0 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 37, 7} true;
  $p16 := $and.i64($p2, 9151314442816847872);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 37, 7} true;
  $p17 := $eq.i64($p16, 72057594037927936);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 39, 4} true;
...
$bb4:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 33, 3} true;
  $p12 := $zext.i1.i32($p11);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 34, 7} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 55, 1} true;
  $exn := false;
  return;
$bb7:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 34, 7} true;
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 49, 2} true;
  $p30 := $M.2;
  call {:cexpr "j"} boogie_si_record_i64($p30);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 50, 2} true;
  $p31 := $add.ref($add.ref(rdtp, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(32, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 50, 2} true;
  $M.35[$p31] := $p30;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 51, 2} true;
  // WARNING: unsoundly ignoring inline asm call: call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #6, !dbg !458, !srcloc !459
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 52, 2} true;
  $p32 := $add.ref($add.ref(rdtp, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(24, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 52, 2} true;
  call atomic_inc($p32);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 53, 2} true;
  // WARNING: unsoundly ignoring inline asm call: call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #6, !dbg !461, !srcloc !462
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 54, 2} true;
...
$bb10:
  assume !(($p17 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 41, 4} true;
  $p19 := $M.34[$p18];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 41, 4} true;
  $p20 := $sub.i64($p19, 72057594037927936);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 41, 4} true;
  $M.34[$p18] := $p20;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 43, 4} true;
...
$bb12:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 43, 4} true;
  $p29 := $zext.i1.i32($p28);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 44, 4} true;
  goto $bb6;
$bb13:
  assume ($p36 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 54, 2} true;
...
$bb0:
  call {:cexpr "rdtp"} boogie_si_record_ref(rdtp);
  call {:cexpr "irq"} boogie_si_record_i32(irq);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 97, 6} true;
  $p0 := $ne.i32(irq, 0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 98, 3} true;
  $p1 := $add.ref($add.ref(rdtp, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(16, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 98, 3} true;
  $p2 := $M.34[$p1];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 97, 6} true;
...
$bb1:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 98, 3} true;
  $M.34[$p1] := $p3;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 99, 3} true;
  $p4 := $add.ref($add.ref(rdtp, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(16, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 99, 3} true;
  $p5 := $M.34[$p4];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 99, 3} true;
...
$bb2:
  assume !(($p0 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 108, 7} true;
  $p16 := $and.i64($p2, 9151314442816847872);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 108, 7} true;
  $p17 := $ne.i64($p16, 0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 109, 4} true;
  $p18 := $add.ref($add.ref(rdtp, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(16, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 108, 7} true;
  goto $bb9, $bb10;
$bb3:
...
$bb4:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 99, 3} true;
  $p12 := $zext.i1.i32($p11);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 100, 7} true;
  $p13 := $add.ref($add.ref(rdtp, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(16, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 100, 7} true;
  $p14 := $M.34[$p13];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 100, 7} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 137, 1} true;
  $exn := false;
  return;
$bb7:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 100, 7} true;
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 118, 2} true;
  // WARNING: unsoundly ignoring inline asm call: call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #6, !dbg !454, !srcloc !455
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 119, 2} true;
  $p30 := $add.ref($add.ref(rdtp, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(24, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 119, 2} true;
  call atomic_inc($p30);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 120, 2} true;
  // WARNING: unsoundly ignoring inline asm call: call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #6, !dbg !457, !srcloc !458
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 121, 2} true;
...
$bb9:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 109, 4} true;
  $M.34[$p18] := $p20;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 110, 4} true;
  $p21 := $add.ref($add.ref(rdtp, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(16, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 110, 4} true;
  $p22 := $M.34[$p21];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 110, 4} true;
...
$bb10:
  assume !(($p17 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 113, 4} true;
...
$bb12:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 110, 4} true;
  $p29 := $zext.i1.i32($p28);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 111, 4} true;
  goto $bb6;
$bb13:
  assume ($p37 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 121, 2} true;
...
$bb14:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 121, 2} true;
  $p43 := $zext.i1.i32($p42);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 132, 6} true;
  $p44 := $M.9;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 132, 6} true;
  $p45 := $M.7;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 132, 6} true;
...
$bb16:
  assume !(($p46 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 136, 2} true;
  ...
  modifies $pthreadStatus, $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2, $M.3, $M.4, $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.18, $M.19, $M.20, $M.21, $M.22, $M.23, $M.24, $M.25, $M.26, $M.27, $M.28, $M.29, $M.30, $M.31, $M.32, $M.33, $M.34, $M.35, $M.36, $M.37;
{
  ...
  var $p8: i32;
$bb0:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 68, 2} true;
  $p0 := $M.6;
  call {:cexpr "oldstate"} boogie_si_record_i32($p0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 76, 2} true;
  $p1 := $p0;
  goto $bb1;
$bb1:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 76, 2} true;
...
$bb2:
  assume ($p2 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 77, 17} true;
  call corral_atomic_begin();
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 77, 17} true;
  $p3 := $M.6;
...
$bb3:
  assume !(($p2 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 86, 2} true;
  ...
  assume true;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 87, 1} true;
  goto $bb9;
$bb4:
  assume ($p4 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 77, 17} true;
...
$bb6:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 79, 7} true;
  $p5 := $eq.i32($p1, $p3);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 79, 7} true;
  $p6 := $eq.i32($p1, 4);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 79, 7} true;
...
$bb7:
  assume ($p7 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 81, 4} true;
  $p8 := $M.7;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 81, 4} true;
  call rcu_kick_nohz_cpu($p8);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 82, 4} true;
  goto $bb9;
$bb8:
  assume !(($p7 == 1));
  call {:cexpr "oldstate"} boogie_si_record_i32($p3);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 85, 2} true;
  $p1 := $p3;
  goto $bb1;
$bb9:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 87, 1} true;
...
$bb0:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 272, 6} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 280, 1} true;
  $exn := false;
  return;
$bb3:
  assume !(($p2 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 274, 6} true;
  $p3 := $trunc.i8.i1($p0);
  $p4 := $M.4;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 274, 6} true;
  $p5 := $sle.i32($p4, 4);
...
$bb5:
  assume !(($p6 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 276, 6} true;
  $p7 := $ne.i32(isidle, 0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 276, 6} true;
  goto $bb6, $bb7;
$bb6:
  assume ($p7 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 277, 3} true;
  call rcu_sysidle(maxj);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 277, 3} true;
  goto $bb2;
$bb7:
  assume !(($p7 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle.h", 279, 3} true;
...
$bb0:
  call {:cexpr "arg"} boogie_si_record_ref(arg);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 98, 3} true;
  $p0 := arg;
  call {:cexpr "tap"} boogie_si_record_ref($p0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 100, 3} true;
  $p1 := $add.ref($add.ref($p0, $zext.i32.ref($mul.i32(0, 4))), $zext.i32.ref($mul.i32(0, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 100, 3} true;
  $p2 := $M.0[$p1];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 100, 3} true;
  ...
  call {:cexpr "my_smp_processor_id"} boogie_si_record_i32($p2);
  call {:cexpr "i"} boogie_si_record_i32(0);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 101, 8} true;
  $p3 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 101, 8} true;
...
$bb2:
  assume ($p4 == 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 102, 5} true;
  $p5 := $M.2;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 102, 5} true;
  $p6 := $add.i64($p5, 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 102, 5} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 105, 5} true;
  $p7 := $M.14[rcu_preempt_data_array];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 105, 5} true;
  call do_fqs(rcu_preempt_state, $p7);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 101, 25} true;
  $p8 := $add.i32($p3, 1);
...
$bb3:
  assume !(($p4 == 1));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 109, 3} true;
  $p9 := $M.3;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 109, 3} true;
  $p10 := $add.i32($p9, 1);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 109, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_bug_0/sysidle_sat.c", 110, 1} true;
  $r := $u11;
  $exn := false;
  return;
}

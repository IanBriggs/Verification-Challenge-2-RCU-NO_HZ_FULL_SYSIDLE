...
$bb0:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_no_corral_atomics/atomic_sat.h", 91, 3} true;
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_no_corral_atomics/atomic_sat.h", 91, 3} true;
  $M.37[$p3] := $p2;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_no_corral_atomics/atomic_sat.h", 92, 1} true;
  $exn := false;
  return;
}
...
$bb0:
  call {:cexpr "v"} boogie_si_record_ref(v);
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_no_corral_atomics/atomic_sat.h", 29, 2} true;
  $p0 := $add.ref($add.ref(v, $zext.i32.ref($mul.i32(0, 4))), $zext.i32.ref($mul.i32(0, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_no_corral_atomics/atomic_sat.h", 29, 2} true;
  $p1 := $M.0[$p0];
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_no_corral_atomics/atomic_sat.h", 29, 2} true;
...
$bb0:
  ...
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_no_corral_atomics/atomic_sat.h", 41, 2} true;
  $p0 := $add.ref($add.ref(v, $zext.i32.ref($mul.i32(0, 4))), $zext.i32.ref($mul.i32(0, 1)));
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_no_corral_atomics/atomic_sat.h", 41, 2} true;
  $M.34[$p0] := i;
  assume {:sourceloc "/users/ibriggs/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle_sat_no_corral_atomics/atomic_sat.h", 42, 1} true;
  $exn := false;
  return;
}

...
procedure $init_funcs()
  modifies $pthreadStatus, $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2, $M.3, $M.4, $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.18, $M.19, $M.20, $M.21, $M.22, $M.23, $M.24, $M.25, $M.26, $M.27, $M.28, $M.29, $M.30, $M.31, $M.32, $M.33, $M.34, $M.35, $M.36, $M.37, $M.38, $M.39, $M.40;
{
...
$bb0:
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 68, 2} true;
  $M.35[$p0] := 1;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 69, 2} true;
  $p2 := $M.2;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 69, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 70, 7} true;
  $p4 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 70, 7} true;
...
$bb2:
  assume ($p6 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 71, 3} true;
  $p7 := $sext.i32.i64($p4);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 71, 3} true;
  $p8 := $add.ref(rdp_in, $mul.ref($p7, $zext.i32.ref(312)));
  call {:cexpr "rdp"} boogie_si_record_ref($p8);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 72, 8} true;
  call $p9 := random();
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 72, 8} true;
  $p10 := $and.i64($p9, 255);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 72, 8} true;
...
$bb3:
  assume !(($p6 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 76, 2} true;
  $p14 := $M.5;
  call {:cexpr "old_full_sysidle_state"} boogie_si_record_i32($p14);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 77, 2} true;
  $p15 := $M.35[$p0];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 77, 2} true;
  $p16 := $trunc.i8.i1($p15);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 77, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 78, 2} true;
  $p19 := $M.5;
  call {:cexpr "new_full_sysidle_state"} boogie_si_record_i32($p19);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 79, 6} true;
  $p20 := $ne.i32($p14, $p19);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 79, 6} true;
  goto $bb7, $bb8;
$bb4:
  assume ($p11 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 73, 4} true;
...
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 74, 3} true;
  call rcu_sysidle_check_cpu($p8, $p0, $p1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 70, 28} true;
  $p13 := $add.i32($p4, 1);
...
$bb7:
  assume ($p20 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 80, 3} true;
  $p21 := $M.2;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 80, 3} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 83, 2} true;
  $p23 := $M.5;
  call {:cexpr "old_full_sysidle_state"} boogie_si_record_i32($p23);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 84, 6} true;
  $p24 := $eq.i32($p23, 3);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 84, 6} true;
  goto $bb10, $bb11;
$bb10:
  assume ($p24 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 85, 3} true;
  call $p25 := poll(0, 0, 5);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 85, 3} true;
  goto $bb12;
$bb11:
  assume !(($p24 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 87, 3} true;
  call $p26 := poll(0, 0, 1);
  goto $bb12;
$bb12:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 88, 6} true;
...
$bb13:
  assume ($p29 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 90, 3} true;
  $p30 := $M.2;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 90, 3} true;
  call $p31 := printf.ref.i64($add.ref($add.ref(.str27, $zext.i32.ref($mul.i32(0, 24))), $zext.i32.ref($mul.i32(0, 1))), $p30);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 91, 2} true;
  goto $bb15;
$bb14:
  assume !(($p29 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 92, 3} true;
  $p32 := $M.5;
  call {:cexpr "new_full_sysidle_state"} boogie_si_record_i32($p32);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 93, 7} true;
  $p33 := $ne.i32($p32, 4);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 93, 7} true;
  goto $bb16, $bb17;
$bb15:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 99, 1} true;
  $exn := false;
  return;
$bb16:
  assume ($p33 == 1);
...
$bb18:
  assume ($p34 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 95, 4} true;
  $p35 := $M.2;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 95, 4} true;
...
$bb0:
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 160, 6} true;
  $p1 := $sgt.i32(argc, 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 160, 6} true;
  goto $bb1, $bb2;
$bb1:
  assume ($p1 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 161, 16} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 162, 3} true;
  $p5 := $M.3;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 162, 3} true;
  $M.11 := $p5;
  call {:cexpr "nthreads"} boogie_si_record_i32($p5);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 163, 3} true;
  $p6 := $M.3;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 163, 3} true;
  call $p7 := printf.ref.i32($add.ref($add.ref(.str28, $zext.i32.ref($mul.i32(0, 22))), $zext.i32.ref($mul.i32(0, 1))), $p6);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 164, 2} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 160, 6} true;
  assume !(($p1 == 1));
  goto $bb3;
$bb3:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 168, 3} true;
  $p8 := $M.11;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 168, 3} true;
  $p9 := $sext.i32.i64($p8);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 168, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 169, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 172, 3} true;
  $p18 := $M.11;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 172, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 173, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 175, 23} true;
  $p28 := $M.11;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 175, 23} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 176, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 177, 13} true;
  $p38 := $M.11;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 177, 13} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 178, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 179, 9} true;
  $p48 := $M.11;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 179, 9} true;
  ...
  call {:cexpr "i"} boogie_si_record_i32(0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 180, 7} true;
  $p53 := 0;
  goto $bb4;
$bb4:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 180, 7} true;
...
$bb5:
  assume ($p55 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 181, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 181, 3} true;
  $M.0[$p62] := $p58;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 182, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 183, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 183, 3} true;
  $M.0[$p70] := $p53;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 184, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 184, 3} true;
  $M.0[$p77] := $p73;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 185, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 186, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 186, 3} true;
  $M.0[$p85] := $p53;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 187, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 188, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 189, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 191, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 191, 3} true;
  $M.0[$p100] := $p53;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 180, 28} true;
  $p101 := $add.i32($p53, 1);
...
$bb6:
  assume !(($p55 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 193, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 194, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 195, 10} true;
  call $p104 := time(0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 195, 10} true;
  $p105 := $trunc.i64.i32($p104);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 195, 2} true;
  call srandom($p105);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 219, 2} true;
  call $p106 := printf.ref($add.ref($add.ref(.str29, $zext.i32.ref($mul.i32(0, 20))), $zext.i32.ref($mul.i32(0, 1))));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 220, 2} true;
  $p107 := $add.ref($p52, $mul.ref(0, $zext.i32.ref(4)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 220, 2} true;
  $p108 := $add.ref($p42, $mul.ref(0, $zext.i32.ref(4)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 220, 2} true;
  $p109 := $p108;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 220, 2} true;
  call $p110 := pthread_create($p107, 0, timekeeping_cpu, $p109);
  call {:cexpr "i"} boogie_si_record_i32(1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 221, 7} true;
  $p111 := 1;
  goto $bb7;
$bb7:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 221, 7} true;
  $p112 := $M.11;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 221, 7} true;
  $p113 := $slt.i32($p111, $p112);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 221, 7} true;
  goto $bb8, $bb9;
$bb8:
  assume ($p113 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 222, 3} true;
  $p114 := $sext.i32.i64($p111);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 222, 3} true;
  $p115 := $add.ref($p52, $mul.ref($p114, $zext.i32.ref(4)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 222, 3} true;
  $p116 := $sext.i32.i64($p111);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 222, 3} true;
  $p117 := $add.ref($p42, $mul.ref($p116, $zext.i32.ref(4)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 222, 3} true;
  $p118 := $p117;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 222, 3} true;
  call $p119 := pthread_create($p115, 0, other_cpu, $p118);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 221, 28} true;
  $p120 := $add.i32($p111, 1);
  call {:cexpr "i"} boogie_si_record_i32($p120);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 221, 28} true;
  $p111 := $p120;
  goto $bb7;
$bb9:
  assume !(($p113 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 224, 2} true;
  call $p121 := sleep(10);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 225, 2} true;
  $M.10 := 0;
  call {:cexpr "goflag"} boogie_si_record_i32(0);
  call {:cexpr "i"} boogie_si_record_i32(0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 226, 7} true;
  $p122 := 0;
  goto $bb10;
$bb10:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 226, 7} true;
...
$bb11:
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 229, 7} true;
  $p125 := $sext.i32.i64($p122);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 229, 7} true;
  $p126 := $add.ref($p52, $mul.ref($p125, $zext.i32.ref(4)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 229, 7} true;
  $p127 := $M.0[$p126];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 229, 7} true;
  call $p128 := pthread_join($p127, $p0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 229, 7} true;
  $p129 := $ne.i32($p128, 0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 229, 7} true;
  goto $bb13, $bb14;
$bb12:
  assume !(($p124 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p131 := $M.5;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p132 := $ne.i32($p131, 4);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
...
$bb13:
  assume ($p129 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 230, 4} true;
  call perror($add.ref($add.ref(.str30, $zext.i32.ref($mul.i32(0, 15))), $zext.i32.ref($mul.i32(0, 1))));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 231, 4} true;
  call abort();
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 231, 4} true;
  assume false;
$bb14:
  assume !(($p129 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 226, 28} true;
  $p130 := $add.i32($p122, 1);
  call {:cexpr "i"} boogie_si_record_i32($p130);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 226, 28} true;
  $p122 := $p130;
  goto $bb10;
$bb15:
...
$bb16:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p150 := $zext.i1.i32($p133);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  call __SMACK_dummy($p150);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p151 := $M.5;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p152 := $ne.i32($p151, 4);
...
$bb17:
  assume !(($p132 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p134 := $M.14[rcu_preempt_data_array];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p135 := $add.ref($p134, $mul.ref(1, $zext.i32.ref(312)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p136 := $add.ref($add.ref($p135, $zext.i32.ref($mul.i32(0, 312))), $zext.i32.ref($mul.i32(184, 1)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p137 := $M.0[$p136];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p138 := $add.ref($add.ref($p137, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(24, 1)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  call $p139 := atomic_read($p138);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p140 := $and.i32($p139, 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p141 := $eq.i32($p140, 0);
...
$bb18:
  assume ($p141 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p142 := $M.14[rcu_preempt_data_array];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p143 := $add.ref($p142, $mul.ref(2, $zext.i32.ref(312)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p144 := $add.ref($add.ref($p143, $zext.i32.ref($mul.i32(0, 312))), $zext.i32.ref($mul.i32(184, 1)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p145 := $M.0[$p144];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p146 := $add.ref($add.ref($p145, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(24, 1)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  call $p147 := atomic_read($p146);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p148 := $and.i32($p147, 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p149 := $eq.i32($p148, 0);
...
$bb21:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p170 := $zext.i1.i32($p153);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  assert $p170 != 0;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 239, 2} true;
  call $p171 := printf.ref($add.ref($add.ref(.str31, $zext.i32.ref($mul.i32(0, 21))), $zext.i32.ref($mul.i32(0, 1))));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 240, 1} true;
  $r := 0;
  $exn := false;
  return;
$bb22:
  assume !(($p152 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p154 := $M.14[rcu_preempt_data_array];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p155 := $add.ref($p154, $mul.ref(1, $zext.i32.ref(312)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p156 := $add.ref($add.ref($p155, $zext.i32.ref($mul.i32(0, 312))), $zext.i32.ref($mul.i32(184, 1)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p157 := $M.0[$p156];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p158 := $add.ref($add.ref($p157, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(24, 1)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  call $p159 := atomic_read($p158);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p160 := $and.i32($p159, 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p161 := $eq.i32($p160, 0);
...
$bb23:
  assume ($p161 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p162 := $M.14[rcu_preempt_data_array];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p163 := $add.ref($p162, $mul.ref(2, $zext.i32.ref(312)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p164 := $add.ref($add.ref($p163, $zext.i32.ref($mul.i32(0, 312))), $zext.i32.ref($mul.i32(184, 1)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p165 := $M.0[$p164];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p166 := $add.ref($add.ref($p165, $zext.i32.ref($mul.i32(0, 40))), $zext.i32.ref($mul.i32(24, 1)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  call $p167 := atomic_read($p166);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p168 := $and.i32($p167, 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 235, 2} true;
  $p169 := $eq.i32($p168, 0);
...
$bb0:
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 120, 2} true;
  $p0 := arg;
  call {:cexpr "tap"} boogie_si_record_ref($p0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 122, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 123, 2} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 124, 2} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 124, 2} true;
  $p8 := $M.10;
...
$bb2:
  assume ($p9 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 126, 3} true;
  $p10 := $M.5;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 126, 3} true;
  $p11 := $sgt.i32($p10, 2);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 126, 3} true;
...
$bb3:
  assume !(($p9 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 151, 1} true;
  $r := $u44;
  $exn := false;
  return;
$bb4:
...
$bb5:
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 126, 3} true;
  $p16 := $zext.i1.i32($p15);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 127, 17} true;
  call $p17 := random();
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 127, 17} true;
  $p18 := $srem.i64($p17, 10);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 127, 17} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 127, 3} true;
  call $p21 := poll(0, 0, $p20);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 128, 3} true;
  $p22 := $M.5;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 128, 3} true;
  $p23 := $sgt.i32($p22, 2);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 128, 3} true;
...
$bb7:
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 128, 3} true;
  $p28 := $zext.i1.i32($p27);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 131, 3} true;
  call rcu_sysidle_enter($p7, 0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 132, 3} true;
  call $p29 := poll(0, 0, 1);
  call {:cexpr "nest"} boogie_si_record_i32(0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 136, 3} true;
  $p30 := 0;
  goto $bb8;
$bb8:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 136, 10} true;
  call $p31 := random();
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 136, 10} true;
  $p32 := $and.i64($p31, 256);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 136, 10} true;
...
$bb9:
  assume ($p33 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 137, 4} true;
  call rcu_sysidle_exit($p7, 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 138, 4} true;
  $p34 := $add.i32($p30, 1);
  call {:cexpr "nest"} boogie_si_record_i32($p34);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 139, 3} true;
  $p30 := $p34;
  goto $bb8;
$bb10:
  assume !(($p33 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 140, 3} true;
  call $p35 := poll(0, 0, 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 141, 3} true;
  $p36 := $p30;
  goto $bb11;
$bb11:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 141, 3} true;
...
$bb12:
  assume ($p38 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 142, 4} true;
  call rcu_sysidle_enter($p7, 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 143, 3} true;
  $p36 := $p37;
  goto $bb11;
$bb13:
  assume !(($p38 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 146, 17} true;
  call $p39 := random();
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 146, 17} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 146, 3} true;
  call $p43 := poll(0, 0, $p42);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 149, 3} true;
  call rcu_sysidle_exit($p7, 0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 150, 2} true;
  goto $bb1;
}
...
$bb0:
  call {:cexpr "rsp"} boogie_si_record_ref(rsp);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 46, 2} true;
  $r := 0;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 41, 2} true;
  call $p0 := printf.ref.i32($add.ref($add.ref(.str32, $zext.i32.ref($mul.i32(0, 45))), $zext.i32.ref($mul.i32(0, 1))), cpu);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 42, 1} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 104, 2} true;
  $p0 := arg;
  call {:cexpr "tap"} boogie_si_record_ref($p0);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 106, 2} true;
  $p1 := $add.ref($add.ref($p0, $zext.i32.ref($mul.i32(0, 4))), $zext.i32.ref($mul.i32(0, 1)));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 106, 2} true;
  $p2 := $M.0[$p1];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 106, 2} true;
  $M.8 := $p2;
  call {:cexpr "my_smp_processor_id"} boogie_si_record_i32($p2);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 107, 2} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 107, 2} true;
  $p3 := $M.10;
...
$bb2:
  assume ($p4 == 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 108, 3} true;
  $p5 := $M.2;
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 108, 3} true;
  $p6 := $add.i64($p5, 1);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 108, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 111, 3} true;
  $p7 := $M.14[rcu_preempt_data_array];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 111, 3} true;
  call do_fqs(rcu_preempt_state, $p7);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 112, 3} true;
  $p8 := $M.15[rcu_sched_data_array];
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 112, 3} true;
  call do_fqs(rcu_sched_state, $p8);
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 113, 2} true;
  goto $bb1;
$bb3:
  assume !(($p4 == 1));
  assume {:sourceloc "/home/vagrant/smack/Verification-Challenge-2-RCU-NO_HZ_FULL_SYSIDLE/src/sysidle/sysidle.c", 114, 1} true;
  $r := $u9;
  $exn := false;
  return;
}
...
axiom (.str31 == -3190);
axiom (.str32 == -3235);
axiom (__SMACK_nondet.XXX == -3239);
axiom (__SMACK_init_func_corral_primitives == -3247);
axiom (__SMACK_top_decl == -3255);
axiom (__SMACK_init_func_thread == -3263);
axiom (__SMACK_code == -3271);
axiom (pthread_self == -3279);
axiom (llvm.dbg.declare == -3287);
axiom (pthread_join == -3295);
axiom (pthread_exit == -3303);
axiom (pthread_mutexattr_init == -3311);
axiom (pthread_mutexattr_settype == -3319);
axiom (pthread_mutex_init == -3327);
axiom (pthread_mutex_lock == -3335);
axiom (pthread_mutex_unlock == -3343);
axiom (pthread_mutex_destroy == -3351);
axiom (pthread_cond_init == -3359);
axiom (pthread_cond_wait == -3367);
axiom (pthread_cond_signal == -3375);
axiom (pthread_cond_broadcast == -3383);
axiom (pthread_cond_destroy == -3391);
axiom (__call_wrapper == -3399);
axiom (pthread_create == -3407);
axiom (cpu_relax_poll == -3415);
axiom (cpu_relax_poll_random == -3423);
axiom (call_rcu == -3431);
axiom (rcu_sysidle_force_exit == -3439);
axiom (rcu_kick_nohz_cpu == -3447);
axiom (rcu_sys_is_idle == -3455);
axiom (abort == -3463);
axiom (rcu_sysidle_check_cpu == -3471);
axiom (rcu_sysidle_report == -3479);
axiom (rcu_gp_in_progress == -3487);
axiom (rcu_sysidle_cb == -3495);
axiom (do_fqs == -3503);
axiom (random == -3511);
axiom (poll == -3519);
axiom (printf == -3527);
axiom (timekeeping_cpu == -3535);
axiom (other_cpu == -3543);
axiom (rcu_sysidle_enter == -3551);
axiom (rcu_sysidle_exit == -3559);
axiom (main == -3567);
axiom (atoi == -3575);
axiom (malloc == -3583);
axiom (llvm.memset.p0i8.i64 == -3591);
axiom (atomic_set == -3599);
axiom (srandom == -3607);
axiom (time == -3615);
axiom (sleep == -3623);
axiom (perror == -3631);
axiom (atomic_read == -3639);
axiom (atomic_inc == -3647);
axiom (rcu_sysidle == -3655);
axiom (rcu_sysidle_cancel == -3663);
axiom (rcu_sysidle_delay == -3671);
axiom (__SMACK_dummy == -3679);
axiom (__SMACK_nondet == -3687);
axiom (__SMACK_decls == -3695);
axiom (__VERIFIER_error == -3703);
axiom (__VERIFIER_assume == -3711);
axiom (exit == -3719);
axiom (__VERIFIER_nondet_char == -3727);
axiom (__VERIFIER_nondet_short == -3735);
axiom (__VERIFIER_nondet_int == -3743);
axiom (__VERIFIER_nondet_long == -3751);
axiom (__VERIFIER_nondet_uchar == -3759);
axiom (__VERIFIER_nondet_ushort == -3767);
axiom (__VERIFIER_nondet_uint == -3775);
axiom (__VERIFIER_nondet_ulong == -3783);
axiom (__VERIFIER_nondet_pointer == -3791);
axiom (llvm.dbg.value == -3799);
